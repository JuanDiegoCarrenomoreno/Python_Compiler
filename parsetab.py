...
_lr_productions = [
  ...
  ('program -> block','program',1,'p_program','A_Sin.py',24),
  ('block -> constDecl varDecl procDecl statement','block',4,'p_block','A_Sin.py',29),
  ('constDecl -> CONST constAssignmentList SEMMICOLOM','constDecl',3,'p_constDecl','A_Sin.py',34),
  ('constDecl -> empty','constDecl',1,'p_constDeclEmpty','A_Sin.py',39),
  ('constAssignmentList -> ID ASSIGN NUMBER','constAssignmentList',3,'p_constAssignmentList1','A_Sin.py',44),
  ('constAssignmentList -> constAssignmentList COMMA ID ASSIGN NUMBER','constAssignmentList',5,'p_constAssignmentList2','A_Sin.py',49),
  ('varDecl -> VAR identList SEMMICOLOM','varDecl',3,'p_varDecl1','A_Sin.py',54),
  ('varDecl -> empty','varDecl',1,'p_varDeclEmpty','A_Sin.py',59),
  ('identList -> ID','identList',1,'p_identList1','A_Sin.py',64),
  ('identList -> identList COMMA ID','identList',3,'p_identList2','A_Sin.py',69),
  ('procDecl -> procDecl PROCEDURE ID SEMMICOLOM block SEMMICOLOM','procDecl',6,'p_procDecl1','A_Sin.py',74),
  ('procDecl -> empty','procDecl',1,'p_procDeclEmpty','A_Sin.py',79),
  ('statement -> ID UPDATE expression','statement',3,'p_statement1','A_Sin.py',84),
  ('statement -> CALL ID','statement',2,'p_statement2','A_Sin.py',89),
  ('statement -> BEGIN statementList END','statement',3,'p_statement3','A_Sin.py',94),
  ('statement -> IF condition THEN statement','statement',4,'p_statement4','A_Sin.py',99),
  ('statement -> WHILE condition DO statement','statement',4,'p_statement5','A_Sin.py',104),
  ('statement -> empty','statement',1,'p_statementEmpty','A_Sin.py',109),
  ('statementList -> statement','statementList',1,'p_statementList1','A_Sin.py',114),
  ('statementList -> statementList SEMMICOLOM statement','statementList',3,'p_statementList2','A_Sin.py',119),
  ('condition -> ODD expression','condition',2,'p_condition1','A_Sin.py',124),
  ('condition -> expression relation expression','condition',3,'p_condition2','A_Sin.py',129),
  ('relation -> ASSIGN','relation',1,'p_relation1','A_Sin.py',134),
  ('relation -> NE','relation',1,'p_relation2','A_Sin.py',139),
  ('relation -> LT','relation',1,'p_relation3','A_Sin.py',144),
  ('relation -> GT','relation',1,'p_relation4','A_Sin.py',149),
  ('relation -> LTE','relation',1,'p_relation5','A_Sin.py',154),
  ('relation -> GTE','relation',1,'p_relation6','A_Sin.py',159),
  ('expression -> term','expression',1,'p_expression1','A_Sin.py',164),
  ('expression -> addingOperator term','expression',2,'p_expression2','A_Sin.py',169),
  ('expression -> expression addingOperator term','expression',3,'p_expression3','A_Sin.py',174),
  ('addingOperator -> PLUS','addingOperator',1,'p_addingOperator1','A_Sin.py',179),
  ('addingOperator -> MINUS','addingOperator',1,'p_addingOperator2','A_Sin.py',184),
  ('term -> factor','term',1,'p_term1','A_Sin.py',189),
  ('term -> term multiplyingOperator factor','term',3,'p_term2','A_Sin.py',194),
  ('multiplyingOperator -> TIMES','multiplyingOperator',1,'p_multiplyingOperator1','A_Sin.py',199),
  ('multiplyingOperator -> DIVIDE','multiplyingOperator',1,'p_multiplyingOperator2','A_Sin.py',204),
  ('factor -> ID','factor',1,'p_factor1','A_Sin.py',209),
  ('factor -> NUMBER','factor',1,'p_factor2','A_Sin.py',214),
  ('factor -> LPARENT expression RPARENT','factor',3,'p_factor3','A_Sin.py',219),
  ('empty -> <empty>','empty',0,'p_empty','A_Sin.py',224),
]
